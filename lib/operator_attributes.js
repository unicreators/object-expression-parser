...
const { ParseBehavior, ParseBehaviorArray } = require('./parse_behavior');
...
module.exports = {
    ...
    'priority': {
        normalize: function (value) {
            return util.toInt(value, 1, undefined, 0);
        }
    },
    ...
    /*
        children: {
        parseBehavior: ParseBehavior.Default,
        required: ['..'],
    ...
    'children': {
        normalize: {
            schema: {
                ...
                parseBehavior: function (value) {
                    if (util.isNullOrUndefined(value)) return ParseBehavior.Default;
                    value = util.toInt(value);
                    if (util.isNullOrUndefined(value)
                        || (util.inArray(ParseBehaviorArray, value) == false))
                        throw new ArgumentError('parseBehavior', `Property 'parseBehavior' must be of ParseBehavior value.`);
                    return value;
                },
